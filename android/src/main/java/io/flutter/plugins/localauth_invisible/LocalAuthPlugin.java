...
public class LocalAuthPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
  private static final String CHANNEL_NAME = "plugins.flutter.io/local_auth_invisible";
  ...
  private final PluginRegistry.ActivityResultListener resultListener = new PluginRegistry.ActivityResultListener() {
    @Override
  ...
  private void authenticate(MethodCall call, final Result result) {
    ...
    authHelper = new AuthenticationHelper(activity, call, completionHandler);
